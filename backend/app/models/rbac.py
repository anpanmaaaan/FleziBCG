...
class RolePermission(Base):
    ...
    __table_args__ = (
        UniqueConstraint("role_id", "permission_id", "scope_type", "scope_value", name="uq_role_permission_scope"),
    )
...
class RoleScope(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_role_id", "scope_type", "scope_value", name="uq_role_scope_assignment"),
    )
