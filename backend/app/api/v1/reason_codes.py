...
from app.schemas.reason_code import ReasonCodeCreateRequest, ReasonCodeItem, ReasonCodeUpdateRequest
...
def create_reason_code(
    ...
    db: Session = Depends(get_db),
    identity: RequestIdentity = Depends(require_action("admin.master_data.reason_code.manage")),
) -> ReasonCodeItem:
    try:
