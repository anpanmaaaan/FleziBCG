...
def get_operation_status_counts_for_dashboard(db: Session, tenant_id: str) -> dict[str, int]:
    statement = (
...
def get_blocked_operation_counts_by_work_order(db: Session, tenant_id: str) -> dict[str, int]:
    statement = (
