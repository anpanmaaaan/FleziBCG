export const I18N_NAMESPACES = {
  ...
  qualityNonconformances: "qualityNonconformances",
  actionRegistry: "actionRegistry",
  auditLog: "auditLog",
  dispatchQueue: "dispatchQueue",
  ganttStressTestPage: "ganttStressTestPage",
  globalOperationList: "globalOperationList",
  oEEDeepDive: "oEEDeepDive",
  operationExecutionDetail: "operationExecutionDetail",
  operationExecutionOverview: "operationExecutionOverview",
  operationList: "operationList",
  plantHierarchy: "plantHierarchy",
  roleManagement: "roleManagement",
  routingOperationDetail: "routingOperationDetail",
  scopeAssignments: "scopeAssignments",
  securityEvents: "securityEvents",
  sessionManagement: "sessionManagement",
  supervisoryOperationDetail: "supervisoryOperationDetail",
  tenantSettings: "tenantSettings",
  traceability: "traceability",
  userManagement: "userManagement",
  aPSScheduling: "aPSScheduling",
  aIShiftSummary: "aIShiftSummary",
} as const;
