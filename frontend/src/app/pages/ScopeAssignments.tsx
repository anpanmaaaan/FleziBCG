...
export function ScopeAssignments() {
  ...
  return (
    <div className="h-full flex flex-col bg-white">
      <MockWarningBanner
        phase="SHELL"
        note="Scope assignment is not yet connected to backend. Backend tenant isolation and RBAC system remains source of truth for user scope."
      />
      <div className="flex-1 flex flex-col p-6">
        {/* Page header */}
        <div className="flex items-center gap-3 mb-6">
          <h1 className="text-2xl font-bold">Scope Assignments</h1>
