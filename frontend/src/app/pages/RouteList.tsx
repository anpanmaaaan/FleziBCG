...
import { BackendRequiredNotice, PageHeader, RoutingLifecycleBadge } from "@/app/components";
...
export function RouteList() {
  ...
  return (
    <div className="h-full flex flex-col bg-white">
      <PageHeader
        title={t("routeList.title")}
        subtitle={t("routeList.notice.backendRequired")}
        actions={(
                ...
                <thead className="bg-gray-50 border-b">
                  <tr>
                    <th className="px-6 py-3 text-left w-2/5">
                      <div className="mb-2 text-sm font-semibold uppercase text-gray-700">{t("routeList.col.route")}</div>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full rounded border border-gray-300 py-2 pl-9 pr-3 text-sm focus:outline-none focus:ring-2 focus:ring-focus-ring"
                        />
                      </div>
                    </th>
                    <th className="px-6 py-3 text-left w-1/5">
                      <div className="text-sm font-semibold uppercase text-gray-700">{t("routeList.col.lastUpdated")}</div>
                    </th>
                    <th className="px-6 py-3 text-left w-1/5">
                      <div className="text-sm font-semibold uppercase text-gray-700">{t("routeList.col.status")}</div>
                    </th>
                    <th className="px-6 py-3 text-left w-1/5">
                      <span className="text-sm font-semibold uppercase text-gray-700">{t("routeList.col.action")}</span>
                    </th>
                  </tr>
                </thead>
                <tbody>
