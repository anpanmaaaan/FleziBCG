      ...
      {filterDefs.map((entry) => {
        ...
        return (
          <button
            ...
            className={`min-h-11 shrink-0 rounded-full border px-3 py-2 text-xs font-semibold transition active:scale-95 focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2 ${
              active
